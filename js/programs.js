...
const programs = [
    ...
    {
        id: "hoc-additional",
        name: "HOC 5% Additional Assistance for County Employees",
        description: "Additional loan for Montgomery County workers on top of standard assistance programs.",
        savings: "Additional 5% loan (up to $10,000) for Montgomery County workers",
        eligibility: {
            firstTimeBuyer: true,
            creditScore: 640,
            livingInCounty: false,
        ...
        benefits: [
            "Additional 5% loan (up to $10,000) for Montgomery County workers",
            "Can be combined with other HOC down payment assistance programs",
            "Increases total available assistance",
        ],
        requirements: [
            "Must be a Montgomery County employee",
            "Must qualify for primary HOC Mortgage Purchase Program",
            "Must meet income limits based on household size",
        ],
        additionalQuestions: [
            {
                ...
                type: "text",
                question: "What is your position with Montgomery County?",
            },
            {
                id: "employment-years",
                type: "select",
                question: "How long have you been employed by Montgomery County?",
                options: [
                    "Less than 1 year",
                    "1-3 years",
                    "3-5 years",
    ...
    {
        id: "flex-loans",
        name: "Maryland Mortgage Program Flex Loans",
        description: "Several down payment assistance options through the state Maryland Mortgage Program.",
        savings: "Options for $6,000 deferred loan or 3-4% of first mortgage amount",
        eligibility: {
            firstTimeBuyer: false,
            creditScore: 640,
            livingInCounty: false,
        ...
        benefits: [
            "Flex 6000: $6,000 deferred loan",
            "Flex 3% and 4% Loans: percentage of first mortgage amount",
            "Multiple options to fit different financial situations",
        ],
        requirements: [
            "Cannot own other real estate at time of closing",
            "Must use with Maryland Mortgage Program first mortgage",
            "Must meet income limits",
            "Must meet Maryland Mortgage Program requirements",
        ],
        additionalQuestions: [
            {
                ...
                options: [
                    "Fixed amount ($6,000)",
                    "Percentage of loan (3-4%)",
                    "Not sure",
                ],
            },
            {
                id: "mmp-lender-contact",
                type: "radio",
                question: "Have you spoken with a Maryland Mortgage Program approved lender?",
    ...
    {
        id: "mpdu",
        name: "Moderately Priced Dwelling Units (MPDU) Program",
        description: "Offers affordably priced homes to first-time homebuyers with moderate household incomes.",
        savings: "Significant savings on home purchase price compared to market rates",
        eligibility: {
            firstTimeBuyer: true,
            creditScore: 0,
            livingInCounty: true,
            workingInCounty: true,
            countyEmployee: false,
            currentlyOwnProperty: false,
            incomeLimits: {
                1: 75600,
        ...
        benefits: [
            "Access to affordably priced homes below market rates",
            "Monthly mortgage payment will not increase each year",
            "Ability to itemize mortgage interest and real estate taxes on income tax form",
            "30-year control period for price appreciation",
        ],
        requirements: [
            "Must not have owned property in the past five years",
            "Must have moderate household income",
            "Must document ability to afford the mortgage, utilities, and fees",
            "All adult wage earners must provide tax records",
            "Household size must be appropriate to size of unit",
            "Preference given to people who live and/or work in Montgomery County",
        ],
        additionalQuestions: [
            {
                id: "years-in-montgomery",
                type: "select",
                question: "How long have you lived or worked in Montgomery County?",
                options: [
                    "Less than 1 year",
                    "1-3 years",
                    "3-5 years",
            ...
            },
            {
                ...
                type: "text",
                question: "Please list all household members and their ages",
            },
            {
                id: "tax-documents",
                type: "radio",
                question: "Can you provide tax returns for all adult household members?",
                options: ["Yes", "No"],
            },
            {
                id: "current-savings",
...
// Export the programs for use in other files
export { programs };